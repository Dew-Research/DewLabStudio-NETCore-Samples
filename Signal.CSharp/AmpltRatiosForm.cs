...
namespace DSPDemo
{
	...
	public class AmpltRatiosForm : System.Windows.Forms.Form
	{
        ...
        private Dew.Math.Controls.TMtxProgressDialog tMtxProgressDialog1;
        ...
        private void InitializeComponent()
        {
            ...
            Series2 = new Points();
            ChartEditor = new Editor(components);
            tMtxProgressDialog1 = new Dew.Math.Controls.TMtxProgressDialog();
            ...
            // ChartButton
            // 
            ChartButton.Location = new Point(143, 7);
            ChartButton.Name = "ChartButton";
            ChartButton.Size = new Size(98, 29);
            ...
            SpectrumButton.Size = new Size(107, 29);
            ...
            comboBox1.Location = new Point(389, 7);
    ...
    0D
            ...
            Series2.Pointer.Style = PointerStyles.Circle;
    ...
    0D
            ...
            // tMtxProgressDialog1
            // 
            tMtxProgressDialog1.UpdateInterval = 40;
            // 
            // AmpltRatiosForm
            // 
            ...
            Name = "AmpltRatiosForm";
            Text = "OrderTrackingForm";
            Load += AmpltRatiosForm_Load;
