...
namespace DSPDemo
{
	...
	public class WindowsDemoForm : System.Windows.Forms.Form
    {
        ...
        "Window functions"};
            ...
            this.SpectrumChart1.Size = new System.Drawing.Size(845, 379);
            ...
            this.richTextBox1.Size = new System.Drawing.Size(845, 118);
            ...
            this.button2.Location = new System.Drawing.Point(125, 516);
		...
		private void FillSeries() {
			...
			for (int i=0;i<11;i++) 
            {
                if (SpectrumChart1.Series.Count <= i)
                    s = SpectrumChart1.Series.Add(new FastLine());
                else s = SpectrumChart1.Series[i]; 
