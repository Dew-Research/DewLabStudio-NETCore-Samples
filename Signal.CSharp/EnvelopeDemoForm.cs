...
namespace DSPDemo
{
	...
	public class EnvelopeDemoForm : System.Windows.Forms.Form
	{
        ...
        private void InitializeComponent()
        {
            ...
            ComponentResourceManager resources = new ComponentResourceManager(typeof(EnvelopeDemoForm));
            ...
            SignalIncBuffer1 = new TSignalIncBuffer(components);
            SignalDecimator1 = new TSignalDecimator(components);
            SignalIncBuffer2 = new TSignalIncBuffer(components);
            ...
            richTextBox1.Size = new Size(1147, 118);
            ...
            SpectrumChartButton.Size = new Size(123, 29);
            SpectrumChartButton.TabIndex = 1;
    ...
    "Original time signal"
            ...
            SignalChart1.Location = new Point(0, 220);
            ...
            SignalChart1.Series.Add(Series2);
            SignalChart1.Size = new Size(1147, 492);
            // 
            // 
            // 
            // 
    ...
    0D
            ...
            splitter1.Location = new Point(0, 217);
            splitter1.Name = "splitter1";
            splitter1.Size = new Size(1147, 3);
    ...
    "Frequency [Hz]"
            ...
            // 
            // 
            SpectrumChart1.Axes.Depth.Automatic = false;
            SpectrumChart1.Axes.Depth.AutomaticMaximum = false;
            SpectrumChart1.Axes.Depth.AutomaticMinimum = false;
            // 
            // 
            // 
            // 
            ...
            SpectrumChart1.Axes.Depth.Maximum = 0D;
            SpectrumChart1.Axes.Depth.Minimum = 0D;
            // 
            // 
            // 
            // 
            ...
            // 
            // 
            SpectrumChart1.Axes.DepthTop.Automatic = false;
            SpectrumChart1.Axes.DepthTop.AutomaticMaximum = false;
            SpectrumChart1.Axes.DepthTop.AutomaticMinimum = false;
            // 
            // 
            // 
            // 
            ...
            SpectrumChart1.Axes.DepthTop.Maximum = 0D;
            SpectrumChart1.Axes.DepthTop.Minimum = 0D;
            // 
            // 
            // 
            // 
            ...
            // 
            // 
            SpectrumChart1.Axes.Top.Automatic = false;
            SpectrumChart1.Axes.Top.AutomaticMaximum = false;
            SpectrumChart1.Axes.Top.AutomaticMinimum = false;
            // 
            // 
            // 
            // 
            ...
            SpectrumChart1.Axes.Top.Maximum = 0D;
            SpectrumChart1.Axes.Top.Minimum = 0D;
            // 
            // 
            // 
            // 
    ...
    "Frequency spectrum of the envelope"
            ...
            SpectrumChart1.Size = new Size(1147, 217);
            ...
            // 
            // 
            SpectrumChart1.Zoom.Brush.Color = Color.FromArgb(255, 255, 255);
    ...
    0D
            ...
            SpectrumAnalyzer1.Input = SignalIncBuffer1;
            ...
            // SignalIncBuffer1
            // 
            SignalIncBuffer1.ChannelCount = 1;
            SignalIncBuffer1.Complex = false;
            SignalIncBuffer1.DataSerialization = "AAAAAAAAAAAAAAAAAACAPwAAAAAAgB9EAAAAQQAAAAAAE3pHAAAAAAAAAAAAAAAA";
            SignalIncBuffer1.Factor = 11;
            SignalIncBuffer1.FloatPrecision = TMtxFloatPrecision.mvDouble;
            SignalIncBuffer1.FloatPrecisionLock = false;
            SignalIncBuffer1.Input = SignalDecimator1;
            SignalIncBuffer1.IsDouble = true;
            SignalIncBuffer1.Length = 0;
            // 
            // SignalDecimator1
            // 
            SignalDecimator1.ChannelCount = 1;
            SignalDecimator1.Complex = false;
            SignalDecimator1.DataSerialization = "AAAAAAAAQEEAAAAAAACAPwAAAAAAgB9EAAAAQQAAAAAAE3pHAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA";
            SignalDecimator1.EnvelopeFactor = 1;
            SignalDecimator1.Factor = 64;
            SignalDecimator1.FloatPrecision = TMtxFloatPrecision.mvDouble;
            SignalDecimator1.FloatPrecisionLock = false;
            SignalDecimator1.Input = SignalRead1;
            SignalDecimator1.IsDouble = true;
            SignalDecimator1.Length = 12;
            // 
            // SignalIncBuffer2
            // 
            SignalIncBuffer2.ChannelCount = 1;
            SignalIncBuffer2.Complex = false;
            SignalIncBuffer2.DataSerialization = "AAAAAAAAAAAAAAAAAACAPwAAAAAAgB9EAAAAQQAAAAAAE3pHAAAAAAAAAAAAAAAA";
            SignalIncBuffer2.Factor = 13;
            SignalIncBuffer2.FloatPrecision = TMtxFloatPrecision.mvDouble;
            SignalIncBuffer2.FloatPrecisionLock = false;
            SignalIncBuffer2.Input = SignalRead1;
            SignalIncBuffer2.IsDouble = true;
            SignalIncBuffer2.Length = 0;
            // 
            ...
            ClientSize = new Size(1147, 876);
            Controls.Add(panel2);
            Controls.Add(panel1);
            Controls.Add(richTextBox1);
            Name = "EnvelopeDemoForm";
            Text = "EnvelopeDemoForm";
            Load += EnvelopeDemoForm_Load;
